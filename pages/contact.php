		...
		<div id="main-content" class="main-content">
			<div class="page-header">
				<figure class="post-thumbnail">
					<img alt="" src="images/contact-banner1.jpg" >
				</figure>
				<h1 class="title">
								...
								<form action="#" method="post"  class="contact-form">
										...
										<div class="col-sm-4">
											<p class="contact-form-author">
												<input type="text" required="required" size="30" value=""
													name="name" id="author" placeholder="Name">
											</p>
										</div>
										<div class="col-sm-4">
									...
									<p class="contact-form-message">
										<textarea required="required" rows="3" cols="45"
											name="msg" id="message" placeholder="Your message"></textarea>
									</p>
									<p class="form-submit button">
										<button class="hvr-rectangle-out" type="submit" id="submit"
											name="submit" onclick="sendEmail()">Send Message</button>
									</p>
								</form>
							</div>
						</div>
